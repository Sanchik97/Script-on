export default [
	{
		...
		questions: [
			...
			},
			{
				id: '9',
				answerId: '20',
				tips:'Вариант 1: "Имя ЛПР", если вы купили не на 10 лет вперед, это значит, что скоро Вы опять озаботитесь этой покупкой. Поэтому, я предлагаю, чтобы  наш специалист  встретился/связался с Вами и ответил на все Ваши вопросы. Это займет немного времени и ни к чему Вас не обязывает. В понедельник в 10 утра Вас устроит? (или называет другое время, записать) Вариант 2: Вы же будете работать дальше, и возможно наше предложение окажется более выгодным. Поэтому, я предлагаю встретиться/созвониться с ведущим специалистом по нашим продуктам. Он очень грамотно и доступно ответит на все ваши вопросы. У него есть яркая презентация и понятные материалы. На встрече вы получите ответы на все ваши вопросы максимально быстро. Это займет немного времени и ни к чему Вас не обязывает. В понедельник в 10 утра Вас устроит? (или называет другое время, записать)',
				nameOfQuestion:'Уже купили'
			}
		],
		answers: [
			{
